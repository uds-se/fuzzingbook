...
<a href="https://mybinder.org/v2/gh/uds-se/fuzzingbook/master?filepath=notebooks/Basic_Fuzzing.ipynb"><img style="float:right" src="https://mybinder.org/badge.svg" alt="Launch Binder (beta)"></a>
[Interactive version (beta)](https://mybinder.org/v2/gh/uds-se/fuzzingbook/master?filepath=notebooks/Basic_Fuzzing.ipynb) • 
[Download code](https://uds-se.github.io/fuzzingbook/code/Basic_Fuzzing.py) • 
[Table of contents](https://uds-se.github.io/fuzzingbook/Main.html) • 
[Change history](https://github.com/uds-se/fuzzingbook/commits/master/notebooks/Basic_Fuzzing.ipynb) • 
...
* You should know fundamentals of software testing; for instance, from the chapter ["Introduction to Software Testing"](Intro_Testing.html).
...
```
    ...
    Traceback (most recent call last):
      File "<ipython-input-26-f83db3d59a06>", line 5, in <module>
        crash_if_too_long(s)
      File "<ipython-input-19-928c2d2de976>", line 4, in crash_if_too_long
        raise ValueError
    ValueError
...
Using the timeout mechanism from our [Introduction to Testing](Intro_Testing.html), we can interrupt this function after some time.  And yes, it does hang after a few fuzzing inputs.
...
```
    ...
    Traceback (most recent call last):
      File "<ipython-input-22-0cb4a0762fd3>", line 7, in <module>
        hang_if_no_space(s)
      File "<ipython-input-21-5f437edacff4>", line 7, in hang_if_no_space
        i += 1
      File "<ipython-input-21-5f437edacff4>", line 7, in hang_if_no_space
        i += 1
...
```
    ...
    Traceback (most recent call last):
      File "<ipython-input-25-7a1817f3dbfc>", line 2, in <module>
        collapse_if_too_large(long_number)
      File "<ipython-input-23-2c22a83a4dca>", line 3, in collapse_if_too_large
        raise ValueError
    ValueError
